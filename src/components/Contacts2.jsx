                  ...
                  <input type="file" class="hidden" />
						...
						<div class="mb-3 space-y-2 w-full text-xs">
							...
							<div class="flex flex-wrap items-stretch w-full mb-4 relative">
								...
								<input type="text" class="flex-shrink flex-grow flex-auto leading-normal w-px  border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow" placeholder="https://" />
                  </div>
							</div>
							<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
								...
								<div class="flex-auto w-full mb-1 text-xs space-y-2">
									...
									<textarea required="" name="message" id="" class="w-full min-h-[100px] max-h-[300px] h-28 appearance-none block bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Enter your comapny info" spellcheck="false"></textarea>
